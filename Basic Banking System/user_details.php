...
<head>
    ...
    <title>RD Bank | Make Transaction</title>
    <!--Google Fonts-->
...
<body>
    ...
    <header>
    	<div class="container">
        	<nav>
            	<div class="nav-brand">
                	<a href="index.php">
                    	<img src="images/logo2.png" alt="RD Bank Logo">
                    </a>
                </div>
	...
	<footer>
    	...
    	<p>Built by <a href="https://www.linkedin.com/in/darshini-r-381771193/" target="_blank">DARSHINI R</a></p>
